...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class FinbuckleMultiTenantBuilderExtensions
    {
        ...
        public static MultiTenantBuilder<TTenantInfo> WithPortStrategy<TTenantInfo>(this MultiTenantBuilder<TTenantInfo> builder) where TTenantInfo : class, ITenantInfo, new()
        {
