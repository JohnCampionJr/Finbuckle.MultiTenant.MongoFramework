...
public static class SeedService
{
    ...
    {
        var ti = new MongoTenantInfo { Id = "tenant-finbuckle-d043favoiaw", ConnectionString = "mongodb://localhost/isolation-test", Identifier = "finbuckle" };
        ...
        ti = new MongoTenantInfo { Id = "tenant-megacorp-g754dafg", ConnectionString = "mongodb://localhost/isolation-test", Identifier = "megacorp" };
        ...
        ti = new MongoTenantInfo { Id = "tenant-initech-341ojadsfa", ConnectionString = "mongodb://localhost/isolation-initech", Identifier = "initech" };
        conn = new MongoPerTenantConnection(ti);
