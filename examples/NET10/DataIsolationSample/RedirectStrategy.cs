...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class FinbuckleMultiTenantBuilderExtensions
    {
        ...
        public static MultiTenantBuilder<TTenantInfo> WithRedirectStrategy<TTenantInfo>(this MultiTenantBuilder<TTenantInfo> builder, string redirectUrl) where TTenantInfo : class, ITenantInfo, new()
        {
